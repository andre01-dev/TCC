    ...
    <div className="pagina-curso">
      ...
      <main className="conteudo">
        <div className="lado-esquerdo">
          <h1>Compras Online de Forma Segura</h1>

          <div className="video-box">
            <iframe
  src="https://www.youtube.com/embed/qIPzUJ3E0k8"
...
></iframe>
        ...
        <div className="lado-direito">
          <div className="card-curso">
            <p className="tema">Compras Online de Forma Segura</p>
            <p className="tempo">6min</p>

            <h2>Compras Online de Forma Segura</h2>
            <p className="resumo">
